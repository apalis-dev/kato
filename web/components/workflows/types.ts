...
export function workflowNodeRowToReactFlowNode(row: WorkflowNodeRow): WorkflowNode {
	return {
		id: row.id,
		type: "workflow",
...
export function workflowEdgeRowToReactFlowEdge(row: WorkflowEdgeRow): WorkflowEdge {
	return {
		id: row.id,
		type: "workflow",
